...
## Install
- Installed version: `<vX.Y.Z or manual>`
- Installed at: `<YYYY-MM-DD>`
- Installed by: `<script/manual>`
- Deploy path: `<repo>/StatusProject`

## Source
- Source type: `<local|release|manual-copy>`
- Source repo: `<repo-url>`
- Local source path: `<optional local path>`
- Release URL: `<optional release url>`
